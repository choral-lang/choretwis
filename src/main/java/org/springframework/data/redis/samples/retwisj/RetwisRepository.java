...
public class RetwisRepository {
	...
	public void follow(String user, String targetUser) {
		String userUid = findUid(user);
		String targetUid = findUid(targetUser);

		following(userUid).add(targetUid);
		followers(targetUid).add(userUid);
	}
	...
	public void stopFollowing(String user, String targetUser) {
		String userUid = findUid(user);
		String targetUid = findUid(targetUser);

		following(userUid).remove(targetUid);
		followers(targetUid).remove(userUid);
	}
